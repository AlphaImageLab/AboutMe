<img src="photo.png" alt="compare" width="900"/> <br/>
# 个人介绍
...
Below, we give a brief explanation of the motivation of our paper, hoping to help readers further understand our idea.
 ...
 - 2) **_the difficulty fitting semantic label scores:_** It is unrealistic to directly fit the score of point cloud semantic labels according to traditional DDPMs end-to-end because the distribution of 3D scenes is too complex. This is similar to using DDPMs to do 3D scene generation tasks end-to-end.
...
| :---: | :---: |:---------------:| :---: | :---: | :---: |
| CDSegNet | ScanNet |     &check;     | 1,2,4 | 77.9% | [Link1](https://pan.baidu.com/s/1n2vu0j4rRfUC-P6FyYAGYA?pwd=8dnc), [Link2](-) |
| PTv3 + CNF | ScanNet |     &check;     | 4 | 77.7% | [Link1](https://pan.baidu.com/s/1W6U9VSprwVbJUz_Q51Oknw?pwd=un4b), [Link2](-) |
...
| CDSegNet | ScanNet200 |     &check;     | 4 | 36.3% | [Link1](https://pan.baidu.com/s/14xtgpT5p2GC3TBoLucppMA?pwd=a4dq), [Link2](-) |
| PTv3 + CNF | ScanNet200 | &check;  | 4 | 35.9% | [Link1](https://pan.baidu.com/s/17SrfL22kUuSd2kXlLR6Xxg?pwd=t7hi), [Link2](-) |
...
| Model | Benchmark | Only Training Data? | Num GPUs | Val mIoU | checkpoint |
| :---: | :---: |:---------------:| :---: | :---: | :---: |
| CDSegNet | nuScenes |     &check;     | 4 | 81.2% | [Link1](https://pan.baidu.com/s/1Sv79gQr4WUg5TI3fYLbCbA?pwd=ec3e), [Link2](-) |
| PTv3 + CNF | nuScenes |     &check;     | 4 | 80.8% | [Link1](https://pan.baidu.com/s/1M1PkmfgnpQO9XXJH6o0jKw?pwd=5i2i), [Link2](-) |
...
#### Training Tricks
- CDSegNet is tied to PTv3, but we found that PTv3 training is unstable, and even with a fixed seed we cannot ensure that the results are roughly the same each time (fluctuations are around 1.0%).
